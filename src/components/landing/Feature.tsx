...
const Feature: React.FC<FeatureProps> = ({ icon, title, description, className = "" }) => (
  <div className={`bg-card border border-border/50 rounded-xl p-6 hover:shadow-md transition-shadow space-y-4 animate-fade-in delay-100 relative group overflow-hidden ${className}`}>
